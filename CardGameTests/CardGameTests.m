...
-(NSMutableArray*) cardsWithNoSet{
    if(!_cardsWithNoSet){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(1) withSymbol:@"diamond" withShading:@"solid" withColor:@"red"];
        [_cardsWithNoSet addObject:card];
        
        card = [[SetGameCard alloc]initWithNumber:@(1) withSymbol:@"diamond" withShading:@"solid" withColor:@"red"];
        [_cardsWithNoSet addObject:card];
        
        card = [[SetGameCard alloc]initWithNumber:@(3) withSymbol:@"squiggle" withShading:@"open" withColor:@"purple"];
        [_cardsWithNoSet addObject:card];
    }
...
-(NSMutableArray*) cardsWith1SetSameNumber{
    if(!_cardsWith1SetSameNumber){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"diamond" withShading:@"solid" withColor:@"red"];
        [_cardsWith1SetSameNumber addObject:card];
        
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"diamond" withShading:@"solid" withColor:@"red"];
        [_cardsWith1SetSameNumber addObject:card];
        
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"squiggle" withShading:@"open" withColor:@"purple"];
        [_cardsWith1SetSameNumber addObject:card];
    }
...
-(NSMutableArray*) cardsWith2Set{
    if(!_cardsWith2Set){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"diamond" withShading:@"open" withColor:@"purple"];
        [_cardsWith2Set addObject:card];
    }
...
-(NSMutableArray*) cardsWith3Set{
    if(!_cardsWith3Set){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"diamond" withShading:@"solid" withColor:@"purple"];
        [_cardsWith3Set addObject:card];
    }
...
-(NSMutableArray*) cardsWith4Set{
    if(!_cardsWith4Set){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"diamond" withShading:@"solid" withColor:@"green"];
...
-(NSMutableArray*) cardsWith1SetDifferentNumber{
    if(!_cardsWith1SetDifferentNumber){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(3) withSymbol:@"diamond" withShading:@"solid" withColor:@"red"];
...
-(NSMutableArray*) cardsWith1SetDifferentSymbol{
    if(!_cardsWith1SetDifferentSymbol){
        ...
        card = [[SetGameCard alloc]initWithNumber:@(2) withSymbol:@"oval" withShading:@"solid" withColor:@"red"];
        [_cardsWith1SetDifferentSymbol addObject:card];
